...
public class BankingTest {
	...
	public void testSignIn() {
		Assert.assertNotNull(BankingDao.signIn("162121", "iti12"));
	}

	@Test
	public void testCreateAcc() {
		Assert.assertNotNull(BankingDao.createAccount("iti12", "Iti Agrawal",
				"Saving"));
	}
	...
	public void testFundTransfer() {
		Assert.assertNotNull(BankingDao.transfer(2000,
				BankingDao.signIn("162121", "iti12"), "125469"));
	}
}
